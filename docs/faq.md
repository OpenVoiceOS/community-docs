...
We are commited to maintain all core components fully free, any GPL code will live in an optional plugin and be flagged
as such.
...
. An example of this was the replacement of padatious to avoid libfann2
