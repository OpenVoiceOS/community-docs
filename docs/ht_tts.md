...
By default, OVOS uses [ovos-tts-server-plugin](https://github.com/OpenVoiceOS/ovos-tts-server-plugin) and a series of public TTS servers, provided by OVOS community members, to send speech to your device.  If you host your own TTS server, or this option is not acceptable to you, there are many other options to use.
